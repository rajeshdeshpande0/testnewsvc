package pom.infy.testnewsvc.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("testnewsvc");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("testnewsvc");
        ...
        config.getMapConfigs().put("pom.infy.testnewsvc.domain.*", initializeDomainMapConfig(jHipsterProperties));

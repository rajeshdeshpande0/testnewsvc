...
import pom.infy.testnewsvc.web.rest.errors.BadRequestAlertException;
import pom.infy.testnewsvc.web.rest.util.HeaderUtil;
...
@CrossOrigin(origins = "*", allowedHeaders = "*") public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "testnewsvcCustomer";
